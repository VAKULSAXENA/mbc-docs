---
description: Steps to transfer/wrap YES20 tokens from Ethereum to Fusenet
---

# Bridge for YES20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Yes Coin explorer to relay the tokens.
