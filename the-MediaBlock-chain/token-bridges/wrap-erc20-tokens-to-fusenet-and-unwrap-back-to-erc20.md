---
description: Steps to transfer/wrap MediaBlock20 tokens from Ethereum to MediaBlocknet
---

# Bridge for MediaBlock20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/MediaBlock Coin explorer to relay the tokens.
