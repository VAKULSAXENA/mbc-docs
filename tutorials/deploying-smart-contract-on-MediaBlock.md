---
description: Steps on deploying a smart contract on MediaBlocknet through Remix.
---

# Deploying smart contract on MediaBlocknet

MediaBlock Coin is an EVM compatible network, every tool for Ethereum can be used for the MediaBlock Coin network too.
...
Since we interact with remix using Metamask, you need to change the network to MediaBlock Coin network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.MediaBlockscan.io/the-MediaBlock-studio/getting-started/how-to-add-MediaBlock-to-your-metamask) to do that.

You need to have a small balance of MediaBlock on the MediaBlocknet wallet you are using which will be used as Gas for the transactions.
