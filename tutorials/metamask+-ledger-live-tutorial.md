...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on Yes Coin after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “Yes Coin network” and perform the transactions on Yes Coin network through your Ledger device.

Note: To learn how to add Yes Coin RPC follow [this link.](https://docs.yesscan.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
