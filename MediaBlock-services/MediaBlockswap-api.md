---
description: MediaBlockSwap API is an auxiliary service to ease the integration with MediaBlockSwap DEX
---

# MediaBlockswap API

## MediaBlockswap Backend API v0.1.0

The MediaBlockswap Backend REST API is used for generating trading data for frontend clients

## PriceChange

### Get price change for token over last 24 hours

[Back to top](https://github.com/MediaBlockio/MediaBlockswap-service/blob/master/docs/api.md#top)
                        ...
                        "tokenAmounts": [
                            {
                                ...
                                "currency": {
                                    "decimals": 6,
                                    "symbol": "USDC",
                                    "name": "USD Coin on MediaBlock Coin",
                                    "chainId": 39656,
                            ...
                            },
                            {
                                ...
                                "currency": {
                                    "decimals": 18,
                                    "symbol": "WETH",
                                    "name": "Wrapped Ether on MediaBlock Coin",
                                    "chainId": 39656,
...
| Name | Type | Description |
| :--- | :--- | :--- |
| methodName | `String` | The method to call on MediaBlockswap RouterV2 |
