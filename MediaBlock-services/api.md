...
## MediaBlock-studio-backend v0.1.0

The MediaBlock Coin Studio REST API for accessing the data and the services of the MediaBlock Coin network in a simple way. You can use this API to query and interact with the objects of the MediaBlock Coin network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and MediaBlock Coin network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(MediaBlock Coin\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the MediaBlock Coin network |
...
| homeBridgeAddress | `String` | Bridge address on the MediaBlock Coin network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the MediaBlock Coin network |
...
Community is a set of contracts and services. Members of the community are users of the MediaBlock Coin network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the MediaBlock Coin network |
| homeTokenAddress | `String` | Address of the community token on the MediaBlock Coin network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the MediaBlock Coin network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the MediaBlock Coin network |
...
Entity is an account on the MediaBlock Coin network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on MediaBlock Coin network |
...
Tokens are compatible with the MediaBlock20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
...
| networkType | `String` | Network type where the token is issued: mainnet/ropsten/MediaBlock |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| networkType | `String` | mainnet/ropsten/MediaBlock |
| page | `Number` | Page number for pagination |
