...
The Yes Coin Studio REST API for accessing the data and the services of the Yes Coin network in a simple way. You can use this API to query and interact with the objects of the Yes Coin network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Yes Coin network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Yes Coin\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Yes Coin network |
...
| homeBridgeAddress | `String` | Bridge address on the Yes Coin network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Yes Coin network |
...
Community is a set of contracts and services. Members of the community are users of the Yes Coin network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Yes Coin network |
| homeTokenAddress | `String` | Address of the community token on the Yes Coin network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Yes Coin network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Yes Coin network |
...
Entity is an account on the Yes Coin network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Yes Coin network |
...
Tokens are compatible with the YES20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
